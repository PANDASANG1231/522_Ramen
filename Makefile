...
data/processed/train_process.csv data/processed/test_process.csv : \
data/processed/train_df.csv data/processed/test_df.csv src/preprocess.py
	...
	--out_file_train="data/processed/train_process.csv" --out_file_test="data/processed/test_process.csv"
...
data/processed/train_process.csv src/train_model.py
	python3.9 src/train_model.py --train_file="data/processed/train_process.csv" --out_file_train="results/best_model.pkl" \
	--out_file_result="results/"

# test model predictions
results/prediction/prediction.csv results/test_metrics.jpg : data/processed/test_process.csv results/best_model.pkl src/predict.py
	python3.9 src/predict.py --test_file="data/processed/test_process.csv" --model_file="results/best_model.pkl" \
...
clean :
	...
	rm -rf data/processed/train_process.csv
	rm -rf data/processed/test_process.csv
